...
Through the exploration of this dataset our team was able to discover important factors that effect affordability of homes. A typical myth is that higher populated/bigger cities are more expensive, but through our data analysis we were able to show that there is no such correlation. An economy is a very complex system with a large array of factors, population only being one. Altough a city may have higher housing *prices*, it won't neccessarily be less affordable as these cities are typacally more excessable and have more demand for jobs and therefore more higher paying ones, so in many cases they may be more affordable. We were also able to analize how mortgage afordability changes over time, discovering that it is not constant but a variety of factors which are usually specific to that time can influence the current affordability. Finally we were able to discover how lower class citizens are more effected by changes in mortgage affortability, and usually not for the better. We can think about this like buying in bulk, purchasing any service which is upgradable or the even a sales action like upselling, all of these carry the same common theme being that the initial cost is usually the most expensive and if you can afford more you will get more bang for you buck. We can relate this to our topic since land is the limiting factor in real estate, the intial piece of land and shelter is typically the most expensive.  
